      ...
      <section className="relative flex items-center justify-center px-4 py-8 md:py-12">
        <div className="w-full max-w-md mx-auto">
          <Image
            ...
            alt="Abdalla & Leanne Wedding Invitation"
            width={768}
            height={1365}
          ...
          <div className="text-center space-y-6 mb-16">
            ...
            <div className="max-w-2xl mx-auto space-y-6 mt-8">
              <div className="bg-card/50 backdrop-blur-sm border border-accent/20 rounded-2xl p-8 md:p-10 shadow-xl">
                <p className="text-3xl md:text-4xl font-serif text-accent mb-3">Sheraton Jumeirah Beach Resort</p>
                <p className="text-xl md:text-2xl text-muted-foreground mb-6">Dubai, United Arab Emirates</p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-6 border-t border-accent/10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-lg text-foreground">March 22, 2026</span>
                  </div>
